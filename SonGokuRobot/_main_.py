...
from SonGokuRobot import (dispatcher, updater, TOKEN, OWNER_ID, WEBHOOK,SUPPORT_CHAT,
...
PM_START_TEXT = """
Hi {}, My name is {} ! 
"I'm a part of the @Dragon_Ball_Chat and I can help you manage your groups with fun!."
I am Sᴏɴ Gᴏᴋᴜ and I help you manage your groups!
...
→ /start: Start me! If you use in group I'll tell if I am online!.
→ /help: Sends this message! Summary is also given in [this post]("https://t.me/Goku_Updates/69")
 /settings: 
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SonGokuRobot.modules." + module_name)
...
def main():
    ...
    #about_callback_handler = CallbackQueryHandler(SonGokuRobot_about_callback, pattern=r"home_back")
